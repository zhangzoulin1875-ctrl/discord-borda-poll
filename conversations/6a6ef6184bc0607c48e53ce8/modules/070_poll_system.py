...
TZ_TAIPEI = _bot_globals.get("TZ_TAIPEI")
DATA_DIR = Path(str(_bot_globals.get("DATA_DIR", ".")))

# ── 資料檔案 ──
POLLS_FILE = os.path.join(str(DATA_DIR), "polls.json")
...
# 註冊 on_message hook
_bot_globals["handle_poll_message"] = handle_poll_message
