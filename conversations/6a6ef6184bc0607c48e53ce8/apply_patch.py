...
# First restore clean original discord_borda_poll.py
os.system('git checkout discord_borda_poll.py')
...
assert route_target in content, "Route target not found"
...
assert handler_target in content, "Handler target not found"
content = content.replace(handler_target, handler_addition, 1)

# 3. Startup load
startup_target = '    _load_community_chronicle()\n'
assert startup_target in content, "Startup target not found"
...
# 4. Global Scan variables and scan functions
